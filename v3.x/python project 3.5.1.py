...
def rotxfunc(sgndeg):
    ...
    if checkrep.get() == 0:
        ...
        xspeed = xspeed + getdeg()*sgndeg()
        print('Neuer xspeed: '+ str(xspeed))
        reprot()
...
def rotyfunc(sgndeg):
    ...
    if checkrep.get() == 0:
        ...
        yspeed = yspeed + getdeg()*sgndeg
        print('Neuer yspeed: '+ str(yspeed))
        reprot()
...
def rotzfunc(sgndeg):
    ...
    if checkrep.get() == 0:
        ...
        zspeed = zspeed + getdeg()*sgndeg
        print('Neuer zspeed: '+ str(zspeed))
        reprot()
...
def reprot():
    if checkrep.get() == 1:
        ...
        roty(yspeed)
        rotz(zspeed)
        master.after(100, lambda:reprot())
