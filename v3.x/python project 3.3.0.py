...
cbedges.grid(row = 0, column = 17, columnspan = 2, padx = 15, pady = 5)

cbfaces = Checkbutton(master, text = 'Flächen zeichnen', var = check2, command = lambda:(cbedges.deselect(), cbfaces.select(), zeichnen()))
cbfaces.grid(row = 1, column = 17, columnspan = 2, padx = 15, pady = 5)

labeldeg = Label(master, text = 'Drehungswinkel:')
labeldeg.grid(row = 3, column = 17, columnspan = 2)

cbdeg = Checkbutton(master, text = 'deg', var = checkdeg, command = lambda:(cbdeg.select(), cbrad.deselect()))
cbdeg.grid(row = 4, column = 17)
cbdeg.select()

cbrad = Checkbutton(master, text = 'rad', var = checkrad, command = lambda:(cbrad.select(), cbdeg.deselect()))
cbrad.grid(row = 4, column = 18)

editdeg = Entry(master)
editdeg.grid(row = 5,column = 17, columnspan = 2, padx = 15, pady = 5)
editdeg.insert(10,'10')

buttonx = Button(master, text = 'rot x', command = lambda: rotxfunc(1))
buttonx.grid(row = 6, column = 17, padx = 15, pady = 5)

buttony = Button(master, text = 'rot y', command = lambda: rotyfunc(1))
buttony.grid(row = 7, column = 17, padx = 15,  pady = 5)

buttonz = Button(master, text = 'rot z', command = lambda: rotzfunc(1))
buttonz.grid(row = 8, column = 17, padx = 15,  pady = 5)

buttonmx = Button(master, text = 'rot -x', command = lambda: rotxfunc(-1))
buttonmx.grid(row = 6, column = 18, padx = 15,  pady = 5)

buttonmy = Button(master, text = 'rot -y', command = lambda: rotyfunc(-1))
buttonmy.grid(row = 7, column = 18, padx = 15,  pady = 5)

buttonmz = Button(master, text = 'rot -z', command = lambda: rotzfunc(-1))
buttonmz.grid(row = 8, column = 18, padx = 15,   pady = 5)

cbreprot = Checkbutton(master, text = 'weiterdrehen', var = checkrep)
cbreprot.grid(row = 9, column = 17, columnspan = 2, padx = 15, pady = 5)

buttonpause = Button(master, text = 'stop', command = lambda:(cbreprot.deselect()))
buttonpause.grid(row = 17, column = 17, padx = 15, pady = 5)
...
cbkep.grid(row = 12, column = 17, columnspan = 2, pady = 5)
