...
labeloc.grid(row = 17, column = 2, columnspan = 2)

editoc = Entry(master, font = '14', width = 15)
editoc.grid(row = 17, column = 4, columnspan = 3)
editoc.insert(10,'blue')

labelfc = Label(master, text = 'Füllfarbe: ', font = '14')
labelfc.grid(row = 17, column = 9, columnspan = 2)

editfc = Entry(master, font = '14', width = 15)
editfc.grid(row = 17, column = 11, columnspan = 3)
