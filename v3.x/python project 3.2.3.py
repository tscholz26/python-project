...
cbkep.grid(row = 8, column = 17, columnspan = 2, pady = 5)
...
cbdod.grid(row = 9, column = 17, columnspan = 2, pady = 5)

cbwur = Checkbutton(master, text = 'Würfel zeichnen', justify = 'left', var = check7, command = lambda:(deselectall(), cbwur.select(), wuerfel()))
cbwur.grid(row = 10, column = 17, columnspan = 2, pady = 5)

cbz42 = Checkbutton(master, text = 'z42 zeichnen', justify = 'left', var = check8, command = lambda:(deselectall(), cbz42.select(), z42()))
cbz42.grid(row = 11, column = 17, columnspan = 2, pady = 5)

buttonrefresh = Button(master, text = 'Farben aktualisieren', command = zeichnen)
buttonrefresh.grid(row = 14, column = 17, columnspan = 2, padx = 15, pady = 5)

buttonclose = Button(master, text = 'close', command = quit)
buttonclose.grid(row = 14, column = 19, columnspan = 1,padx = 15, pady = 5)
