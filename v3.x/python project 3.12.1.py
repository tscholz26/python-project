...
versionshinweis =  '(Version 3.12.1)'
...
def inffuncgradient():
    time.sleep(0.001)
    master.after(50, lambda:(gradientgetcolor(), zeichnen(), inffuncgradient()))
...
cbkep.grid(row = 11, column = 16, columnspan = 2, pady = 5)
...
cbgradient = Checkbutton(master, text = 'Farbverlauf aktivieren', var = checkgradient, command = initgradient)
