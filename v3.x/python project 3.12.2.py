...
versionshinweis =  '(Version 3.12.2)'
...
cbgradient = Checkbutton(master, text = 'Farbverlauf aktivieren', var = checkgradient, command = lambda:(inffuncgradient()))
...
cbrewriteedit.grid(row = 15, column = 16, columnspan = 2, padx = 5, pady = 15)
