...
canvas1.grid(row = 0,column = 0, rowspan = 10, columnspan = 1, padx = 15, pady = 15)

editdeg = Entry(master)
editdeg.grid(row = 2,column = 1, columnspan = 3, padx = 15, pady = 15)
editdeg.insert(10,'10')

cbedges = Checkbutton(master, text = 'Kanten zeichnen', var = check1, command = lambda:(cbfaces.deselect(), zeichnen()))
cbedges.grid(row = 0, column = 1, columnspan = 3, padx = 15, pady = 15)

cbfaces = Checkbutton(master, text = 'Flächen zeichnen', var = check2, command = lambda:(cbedges.deselect(), zeichnen()))
...
cbiko = Checkbutton(master, text = 'Ikosaeder zeichnen', command = lambda:(cbokt.deselect(), cbkep.deselect(), ikosaeder()))
cbiko.grid(row = 6, column = 1, columnspan = 2, pady = 15)
cbiko.select()

cbokt = Checkbutton(master, text = 'Oktaeder zeichnen', command = lambda:(cbiko.deselect(), cbkep.deselect(), oktaeder()))
cbokt.grid(row = 7, column = 1, columnspan = 2, pady = 15)

cbkep = Checkbutton(master, text = 'Keplerstern zeichnen', command = lambda:(cbiko.deselect(), cbokt.deselect(), keplerstern()))
cbkep.grid(row = 8, column = 1, columnspan = 2, pady = 15)

buttonclose = Button(master, text = 'close', command = quit)
buttonclose.grid(row = 9, column = 1, columnspan = 3,padx = 15, pady = 15)
